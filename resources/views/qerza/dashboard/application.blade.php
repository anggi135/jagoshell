...
<div class="container-fluid">
	<div class="d-flex flex-wrap mb-4 align-items-center search-filter">
		...
		<div class="form-check check-switch custom-checkbox me-4 mb-2">
			...
			<label class="form-check-label" for="customCheck9">Fulltime</label>
		</div>
		<div class="form-check check-switch custom-checkbox me-5 mb-2">
		...
		<div class="mb-0 me-3 mt-3 mt-sm-0 mb-2">
			<select class="default-select style-1 w-auto " aria-label="Default select example">
			  <option data-icon="fa-solid fa-arrow-down-short-wide" selected>Newest</option>
			  <option value="1">Latest</option>
			  <option value="2">Oldest</option>
			
			</select>
		</div>
		<a href="javascript:void(0);" class="me-3 mb-2">
				...
				<table class="table display mb-4 dataTablesCard table-responsive-xl card-table" id="example5">
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a class="btn btn-outline-success rounded  me-3 ms-auto" href="#">Candidate</a>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a class="btn rounded btn-outline-warning me-3 ms-auto" href="#">On-Hold</a>
									<div class="dropdown float-end custom-dropdown mb-0 c-pointer">
										<div class="" data-bs-toggle="dropdown">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#2E2E2E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a class="btn rounded btn-outline-dark me-3 ms-auto" href="#">Pending</a>
									<div class="dropdown float-end custom-dropdown mb-0 c-pointer">
										<div class="" data-bs-toggle="dropdown">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#2E2E2E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<a class="btn rounded btn-outline-success me-3 ms-auto" href="#">Candidate</a>
						...
						<tr>
							<td>
								<div class="checkbox me-0 align-self-center">
									<div class="form-check custom-checkbox ">
										<input type="checkbox" class="form-check-input" id="check7" required="">
