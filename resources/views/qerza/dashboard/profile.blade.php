					...
					<div class="card  flex-lg-column flex-md-row ">
						...
						<div class="card-body">
							<div class="d-flex mb-3 align-items-center">
								<a class="contact-icon me-3" href="#"><i class="fa-solid fa-phone"></i></a>
								<span class="text-black">+50 123 456 7890</span>
							</div>
							<div class="d-flex mb-3 align-items-center">
								<a class="contact-icon me-3" href="#"><i class="fa-brands fa-whatsapp"></i></a>
				...
				<div class="col-xl-12 col-lg-6">
					<div class="card">	
						<div class="card-header border-0 pb-0">
							<h4 class="fs-20 text-black">portfolio</h4>
						...
						<div class="card-body">
							<div class="d-flex mb-3 align-items-center bg-light rounded">
								<svg class="me-3 min-w50" width="50" height="50" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
									<rect width="49" height="49" rx="8" fill="#3D6AD6"/>
							...
							<div class="d-flex mb-3 align-items-center bg-light rounded">
								<svg class="me-3 min-w50" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									<rect width="50" height="50" rx="8" fill="#EA518D"/>
							...
							<div class="d-flex mb-3 align-items-center bg-light rounded">
								<svg class="me-3 min-w50" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									<rect width="50" height="50" rx="8" fill="#0073B1"/>
					...
					<div class="card profile-card">
						<div class="card-header flex-wrap border-0 pb-0">
							...
							<div class="d-sm-flex d-block">
								<div class="d-flex me-5 align-items-center mb-2">
									<div class="form-check custom-switch toggle-switch text-end">
										<input type="checkbox" class="form-check-input" id="customSwitch1">
										<label class="form-check-label" for="customSwitch1">Available for hire?</label>
									</div>
								</div>
								<a href="#" class="btn btn-danger light rounded me-3 mb-2">Cancel</a>
									...
									<div class="row">
										...
										<div class="col-xl-4 col-sm-6">
											<div class="form-group position-relative">
												...
												<span class="show-pass eye style-1" style="display:none;">
										...
										<div class="col-xl-4 col-sm-6">
											<div class="form-group">
												...
												<input type="password" name="confirm_password" id="confirm_password" class="form-control" style="border-color:#C2C2C2;" placeholder="Enter password">
									...
									<div class="row">
										<div class="col-xl-4 col-sm-6">
											<div class="form-group">
												...
												<div class="input-group input-icon mb-3">
													...
													<input type="text" class="form-control rounded" placeholder="Phone no.">
												</div>
										...
										<div class="col-xl-4 col-sm-6">
											<div class="form-group">
												...
												<div class="input-group input-icon mb-3">
													<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon2"><i class="fa-brands fa-whatsapp"></i></span>
													</div>
													<input type="text" class="form-control rounded" placeholder="Whatsapp no.">
												</div>
											</div>
										</div>
										<div class="col-xl-4 col-sm-6">
											<div class="form-group">
												...
												<div class="input-group input-icon mb-3">
													...
													<input type="text" class="form-control rounded" placeholder="Enter email">
												</div>
											</div>
										</div>
										<div class="col-xl-4 col-sm-6">
...
@push('scripts')
<script>
	$("#dz-password").on('change keydown paste input', function(){
		var passwordValue = $(this).val();
		let input= document.getElementById('dz-password')
...
<script>
	$('#dz-password, #confirm_password').on('keyup', function () {
	if ($('#dz-password').val() == $('#confirm_password').val()) {
